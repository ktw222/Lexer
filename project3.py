...
def project3(input: str) -> str:
    #create lexer run lexer create parser
    lexer = LexerFSM()
    lexer.run(input)
...
if __name__ == "__main__":
    input_contents = read_file_contents(r"C:\Users\ktwil\OneDrive\Documents\CS 236\project-3-ktw222\project3-passoff\80\input2.txt")
